...
/**
 ...
 # Important
 * **Your UITableView must have a superview.** This is due to the fact that a transparent view is added over the top of your table view to handle the pan gestures. There are 2 main approaches to accomplishing this:
 ...
 * If you are having trouble getting the table view to end scrolling at the correct point, refer to the section about estimated row heights at the end of this description.
 ...
 class MyTableViewController: UITableViewController {
    ...
    /* It's recommended that you enable when the table view begins editing
...
public class TableViewScrollAndSelectController {
    ...
    */
    ...
    /**
     A Boolean value indicating whether to use the estimated row height of your table view rows to fine tune scrolling.
